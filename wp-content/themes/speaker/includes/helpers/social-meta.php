<?php
/**
 * Speaker Social Meta helper
 *
 * A few functions to generate facebook, twitter and google plus meta
 *
 * @package WordPress
 * @subpackage Speaker
 * @since Speaker 1.0.0
...
if ( ! function_exists( 'wolf_get_meta_share_img' ) ) {
	...
	function wolf_get_meta_share_img( $post_id ) {
		...
		$share_image = wolf_get_theme_option( 'share_img' );
...
<!-- google meta -->
<?php if ( wolf_get_meta_description( $post ) ) : ?><meta name="description" content="<?php echo wolf_get_meta_description( $post ); ?>" />
<?php endif; ?>

<!-- facebook meta -->
<meta property="og:site_name" content="<?php echo $site_name; ?>" />
<meta property="og:title" content="<?php echo wolf_get_wp_title(); ?>" />
<meta property="og:url" content="<?php echo get_permalink( $post_id ); ?>" />
<?php if ( wolf_get_meta_share_img( $post_id ) ) : ?><meta property="og:image" content="<?php echo wolf_get_meta_share_img( $post_id ); ?>" />
<?php endif;
if ( wolf_get_meta_description( $post ) ) : ?><meta property="og:description" content="<?php echo wolf_get_meta_description( $post ); ?>" />
<?php endif; ?>

<!-- twitter meta -->
<meta name="twitter:card" content="summary">
<meta name="twitter:url" content="<?php echo get_permalink( $post_id ); ?>">
<meta name="twitter:title" content="<?php echo wolf_get_wp_title(); ?>">
<?php if ( wolf_get_meta_share_img( $post_id ) ) : ?><meta name="twitter:image" content="<?php echo wolf_get_meta_share_img( $post_id ); ?>">
<?php endif;
if ( wolf_get_meta_description( $post ) ) : ?><meta name="twitter:description" content="<?php echo wolf_get_meta_description( $post ); ?>">
<?php endif; ?>

<!-- google plus meta -->
<meta itemprop="name" content="<?php echo $site_name; ?>" />
<?php if ( wolf_get_meta_share_img( $post_id ) ) : ?><meta itemprop="image" content="<?php echo wolf_get_meta_share_img( $post_id ); ?>" />
<?php endif;
if ( wolf_get_meta_description( $post ) ) : ?><meta itemprop="description" content="<?php echo wolf_get_meta_description( $post ); ?>" />
<?php endif; ?>
	<?php
		}
	}
